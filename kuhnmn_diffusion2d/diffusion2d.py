...
from kuhnmn_diffusion2d.output import create_plot, output_plots


def solve(dx = 0.3, dy = 0.3, D = 4):
    # plate size, mm
    w = h = 10.
    ...
    for n in range(nsteps):
        ...
        # Create figure
        if n in n_output:
            fig_counter, im = create_plot(fig, fig_counter, u, T_cold, T_hot, n, dt)
