...
from diffusion2d_cevikma.output import create_plot, output_plots


def solve(dx=0.1, dy=0.1, D=4.):
    # params dx, dy are intervals in x-, y- directions, mm
    # param D is Thermal diffusivity of steel, mm^2/s
    ...
    for n in range(nsteps):
        ...
        if n in n_output:
            fig_counter += 1
            im = create_plot(fig, fig_counter, u, plt, T_cold, T_hot, n, dt)

    # Plot output figures
    output_plots(fig, im, plt)
